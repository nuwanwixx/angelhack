...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row text-center" style="margin-top: 30px">
    <img src="<?php echo e(url('img/profile.png')); ?>" alt="Work 'N' Hire" class="img-circle" width="20%">
  </div>
  ...
  <div class="row" style="margin-top: 35px">
      <div class="col-md-6 text-center">
        <a href="<?php echo e(url('/')."/jobs"); ?>"><img src="<?php echo e(url('img/jobs.png')); ?>" alt="Find a Job" class="img-circle" width="250px"></a>
      </div>
      <div class="col-md-6 text-center">
        <a href="<?php echo e(url('/')."/mens"); ?>"><img src="<?php echo e(url('img/worker.png')); ?>" alt="Find a Worker" class="img-circle" width="250px"></a>
      </div>
  </div>
